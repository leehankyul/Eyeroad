...
public class MakingMemoAcitivity extends AppCompatActivity {
    ...
    public void makeMemo()
    {
        ...
        if(image_added==false)
            mImageString="";
        insertMemo.execute(mTitleText.getText().toString(),"1","1","1",mBodyText.getText().toString(),stringDate,mImageString,
                String.valueOf(mIconID),deviceID,String.valueOf(mSelectedIndexSet));
        finish();
    }
